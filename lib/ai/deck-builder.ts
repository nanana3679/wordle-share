...
function buildSystemPrompt(): string {
  return [
    ...
    "",
    "STRICT TAG TAXONOMY RULES:",
    "- Tags MUST be objective classifications that would appear as Wikipedia/Namuwiki infobox fields or official franchise categorization.",
    "- BAD (subjective/editorial — forbidden): 'mascot', 'iconic', 'popular', 'main-character', 'active', 'famous', 'legendary-character', 'favorite', 'starter-ish'. Two reasonable fans could disagree → drop it.",
    "- GOOD (objective categorization):",
    "  - Generation / era / debut year: 'gen1', '4th-gen', 'debut-2018', 'wave-1'.",
    "  - Canonical type / class: 'electric-type', 'water-type', 'vocalist', 'rapper', 'starter-pokemon' (starter is an official Pokemon category — OK).",
    "  - Branch / agency / region: 'hololive', 'jp-branch', 'en-branch', 'yg', 'sm'.",
    "  - Group / sub-unit: 'holox', 'hope-world', 'bts', 'newjeans'.",
    "  - Roster status (only if documented in official sources): 'graduated', 'active-member', 'former-member'. NOT 'popular' / 'top-tier'.",
    "- Litmus test: Can you point at a Wikipedia/Namuwiki section or official site page that uses this exact category? If no, drop the tag.",
    "- Tag values: lowercase, hyphenated if multi-word.",
    "- Use 2-4 tags per word. Fewer high-quality tags > many fuzzy ones.",
    "- Tag taxonomy should be CONSISTENT within one deck — don't mix generation-based tags in half and attribute-based in the other half.",
    "- Example for Pokemon: 'pikachu' → ['gen1', 'electric-type']. For Pokemon starter: 'bulbasaur' → ['gen1', 'grass-type', 'starter-pokemon']. For VTuber: 'pekora' → ['hololive', 'jp-branch', 'gen3'].",
    "",
